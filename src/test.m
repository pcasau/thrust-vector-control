global rpm radi h g r bark1 K kp P b gamma delta k k1 svmaxP lbar_aa M_2
%reference
rpm  = 3;
radi = 1;
h    = 1;
...
[t,j,x] = HyEQsolver(@(x) [F_1(x(22),x(1:21));1],...
    @(x) [G_1(x);x(22)],@C_1,@D_1,x0,TSPAN,JSPAN,rule,options);
%Plot Results
N = numel(t);
W1 = zeros(N,1);
for I = 1:N
